...
import com.netease.yunxin.app.listentogether.databinding.FragmentAppEntranceBinding;
  ...
  private void initView() {
    ...
    list.add(
        new FunctionAdapter.FunctionItem(
            getString(R.string.voiceroom_listen_together),
            getString(R.string.app_listen_together_desc),
            R.drawable.home_item_bg_listen_together,
            R.raw.home_listen_together,
            () -> {
              ListenTogetherNavUtils.toListenTogetherRoomListPage(getContext());
            }));
