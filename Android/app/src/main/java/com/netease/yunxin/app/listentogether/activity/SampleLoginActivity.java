...
import com.netease.yunxin.app.listentogether.BuildConfig;
import com.netease.yunxin.app.listentogether.R;
import com.netease.yunxin.app.listentogether.config.AppConfig;
import com.netease.yunxin.app.listentogether.databinding.ActivityListenTogetherSampleLoginBinding;
...
public class SampleLoginActivity extends BasePartyActivity {
  ...
  private ActivityListenTogetherSampleLoginBinding binding;
  ...
  protected View getRootView() {
    hasStart = true;
    binding = ActivityListenTogetherSampleLoginBinding.inflate(getLayoutInflater());
