...
interface NEListenTogetherKit {
     ...
     *
     */
    fun addAuthListener(listener: NEListenTogetherAuthListener)

    /**
     * 移除登录状态监听
     * @param listener 监听器
     */
    fun removeAuthListener(listener: NEListenTogetherAuthListener)
     ...
     * @param callback 回调
     * <br>相关回调：登录成功后，会触发[NEListenTogetherAuthListener.onListenTogetherAuthEvent]回调
     */
     ...
     *
     * @param callback 回调
     * <br>相关回调：登出成功后，会触发[NEListenTogetherAuthListener.onListenTogetherAuthEvent]回调
     */
     ...
     * @return 当前房间信息
     */
    fun getCurrentRoomInfo(): NEListenTogetherRoomInfo?
     ...
     * @param language 目标语言
     */
    fun switchLanguage(language: NEListenTogetherLanguage): Int
}

/**
 * NEListenTogetherKitConfig配置
 * @property appKey NEListenTogetherKit 服务的key
 * @property reuseIM 是否开启IM复用
 * @property extras 额外参数
 */
data class NEListenTogetherKitConfig(val appKey: String, val reuseIM: Boolean = false, val extras: Map<String, Any?> = mapOf()) {
 ...
 * 登录监听器
 */
interface NEListenTogetherAuthListener {
    /**
     * 登录事件回调
     * @param evt 登录事件
     */
    fun onListenTogetherAuthEvent(evt: NEListenTogetherAuthEvent)
}
