 ...
 * 登录事件枚举
 */
enum class NEListenTogetherAuthEvent {
    /**
     * 被踢出登录
     */
    KICK_OUT,
    ...
    companion object {
        fun fromValue(value: String?): NEListenTogetherAuthEvent = when (value) {
            KICK_OUT.name -> KICK_OUT
 ...
 * 错误码
 */
object NEListenTogetherErrorCode {
    /**
     * 通用失败code码
     */
    const val FAILURE = -1
 ...
 * @constructor
 */
enum class NEListenTogetherLiveState(val value: Int) {
    /**
     * 未开始
     */
    NotStart(0),
