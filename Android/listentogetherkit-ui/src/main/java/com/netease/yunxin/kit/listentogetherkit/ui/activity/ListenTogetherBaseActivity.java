        ...
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            if (!NetworkUtils.isConnected()) {
              ToastX.showShortToast(getString(R.string.network_error));
              return;
            }
                        ...
                        .sendBatchGift(
                            ...
                            new NEVoiceRoomCallback<Unit>() {
                              ...
                              public void onFailure(int code, @Nullable String msg) {
                                ToastX.showShortToast(getString(R.string.listen_reward_failed));
                              }
                            }));
          }
        });
        ...
        .joinRoom(
            ...
            new NEVoiceRoomCallback<NEVoiceRoomInfo>() {
              ...
              public void onSuccess(@Nullable NEVoiceRoomInfo roomInfo) {
                ...
                if (roomInfo != null
                    && roomInfo.getLiveModel().getAudienceCount() != null
                    && roomInfo.getLiveModel().getAudienceCount() >= ROOM_MEMBER_MAX_COUNT) {
                  ToastUtils.INSTANCE.showShortToast(
                      ListenTogetherBaseActivity.this,
                      getString(
                          isAnchor
