...
import com.netease.yunxin.kit.listentogetherkit.ui.adapter.LiveBaseAdapter;
import com.netease.yunxin.kit.listentogetherkit.ui.widget.OnItemClickListener;
    ...
    rvMemberList.setAdapter(
        new LiveBaseAdapter<String>(getContext(), items) {
          ...
          protected int getLayoutId(int viewType) {
            return R.layout.listen_view_item_list_text;
          }
