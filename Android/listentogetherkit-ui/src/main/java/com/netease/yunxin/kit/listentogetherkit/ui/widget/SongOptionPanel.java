...
import com.netease.yunxin.kit.listentogetherkit.ui.databinding.ListenSongOptionPanelBinding;
  ...
  private NEVoiceRoomListenerAdapter roomListener =
      new NEVoiceRoomListenerAdapter() {
        ...
        public void onAudioEffectFinished(int effectId) {
          ...
          if (effectId == ListenTogetherConstant.EFFECT_ID && ListenTogetherUtils.isCurrentHost()) {
